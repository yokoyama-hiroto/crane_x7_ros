...
def follow_rectangle_path(
    ...
    # path_1, fraction = arm.compute_cartesian_path(way_points, eef_step, jump_threshold, avoid_collisions)
    # path_2, fraction = arm.compute_cartesian_path(way_points, eef_step, jump_threshold, avoid_collisions)
    # path_n1, fraction = arm.compute_cartesian_path(way_points, eef_step, jump_threshold, avoid_collisions)
    # path_n2, fraction = arm.compute_cartesian_path(way_points, eef_step, jump_threshold, avoid_collisions)
    # path.joint_trajectory.points[0] = path.joint_trajectory.points[1]
    # print(path.joint_trajectory.points[0])
    tgt_points = path.joint_trajectory.points

    print(tgt_points[0:2])
    
    # path.joint_trajectory.points.clear()

    # print(path)

    # 
    # for i in range(0,len(tgt_points)):
    #     path.joint_trajectory.points=tgt_points[i:i+1]
    #     path.joint_trajectory.points[0].velocities = [0,0,0,0,0,0,0]
    #     path.joint_trajectory.points[0].accelerations = [0,0,0,0,0,0,0]
    #     arm.execute(path)
    #     # print('OK')
