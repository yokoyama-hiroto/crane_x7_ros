...
class HybridControl:
    ...
    def control_loop(self):
        ...
        joint_constraint.joint_name = self.arm.get_joints()[6]
        ...
        while not rospy.is_shutdown():
            ...
            if force is not None:
                ...
                current_position = self.arm.get_current_pose().pose.position
                ...
                # next_target_position = self.path[self.path_index+1]
                ...
                for i in range(way_point):
                    target_position = (1-(i+1)/way_point)*self.path[self.path_index] + (i+1)/way_point*self.path[self.path_index+1]
                    desired_position.position.x = target_position[0]
                    desired_position.position.y = target_position[1]
                ...
                rospy.loginfo(self.arm.get_current_pose())
